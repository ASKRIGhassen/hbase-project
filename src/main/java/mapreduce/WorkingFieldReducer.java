...
public class WorkingFieldReducer extends TableReducer<ImmutableBytesWritable, IntWritable, ImmutableBytesWritable> {

    public static final byte[] CF = "working_field".getBytes();
